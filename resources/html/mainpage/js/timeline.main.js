...
function openAdaptationList() {
    document.getElementById("timeline-div").style.width = "calc(100vw - 310px)";
    document.getElementById("side-nav").style.width = "310px";
    document.getElementById("adaptation-items-div").style.width = "250px";
    adaptation_list_OPEN = true;
}

function closeAdaptationList() {
    document.getElementById("adaptation-items-div").style.width = "0px";
    document.getElementById("timeline-div").style.width = "calc(100vw - 60px)";
